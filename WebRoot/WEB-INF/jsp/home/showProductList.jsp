	...
	<table class="border" width="799" align="center" style="margin:0 auto;" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td colspan="2" style="border-bottom: #E3E3E3 1px solid;">
				<iframe src="${pageContext.request.contextPath}/home/webSrc" height="30" width="799" marginheight="0" scrolling="no" frameborder="0" height="100%"></iframe>				
			</td>
		</tr>
		<tr>
			<td style="border-right: #E3E3E3 1px solid;" height="600">
			...
			<td>
				<iframe src="${pageContext.request.contextPath}/home/showProductDetails" width="600" marginheight="0" scrolling="no" frameborder="0" height="100%"></iframe>
			</td>
		</tr>
		<tr height="30">
