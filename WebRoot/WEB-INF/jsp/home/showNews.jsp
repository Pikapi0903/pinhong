...
<html>
  ...
  <body>
	<table class="border" width="799" align="center" style="margin:0 auto;" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td colspan="2" height="30" style="border-bottom: #E3E3E3 1px solid;">
		...
		<tr>
			<td height="420" style="border-right: #E3E3E3 1px solid;">
			...
			<td>
				<iframe src="${pageContext.request.contextPath}/home/newsList" width="613" marginheight="0" scrolling="no" frameborder="0" height="100%"></iframe>
			</td>
		</tr>
		<tr>
